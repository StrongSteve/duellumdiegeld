/**
 * Shared questions data used by both:
 * - prisma/seed.ts (local development)
 * - seeder/seeder.service.ts (Render deployment)
 *
 * Single source of truth for all seed questions.
 */
...
export const seedQuestions: SeedQuestion[] = [
  ...
  // Additional 42 questions
  {
    ...
    description:
      'In El Salvador wurde eine rekordverdächtige Brezel mit einem Gewicht von 783,81 Kilogramm gebacken.',
  },
  {
    questionText:
      'Wie viele Regenschirme bleiben laut Schätzung jedes Jahr in der Londoner U-Bahn zurück?',
    ...
    website: 'https://www.nordbayern.de/panorama/unnutzes-wissen-1.13958782',
    description:
      'Jährlich bleiben etwa 75.000 Regenschirme in der Londoner U-Bahn unbeachtet zurück.',
  },
  {
    questionText:
      'Welche Spannweite in Zentimetern hatte das 2017 entdeckte Rekordexemplar der größten Spinne der Welt?',
    ...
    website: 'https://www.nordbayern.de/panorama/unnutzes-wissen-1.13958782',
    description:
      'Die größte Spinne der Welt stammt aus Australien; 2017 wurde ein Exemplar mit einer Spannweite von etwa 40 Zentimetern entdeckt.',
  },
  {
  ...
  {
    questionText:
      'Mit wie vielen anderen Menschen teilt ein Individuum im Durchschnitt seinen Geburtstag?',
    ...
    website: 'https://www.nordbayern.de/panorama/unnutzes-wissen-1.13958782',
    description:
      'Jedes Individuum hat im Durchschnitt mit etwa 16,5 Millionen anderen Menschen gleichzeitig Geburtstag.',
  },
  {
  ...
  {
    questionText:
      'Wie viele Gramm Gehirnmasse verliert ein erwachsener Mensch im Durchschnitt pro Jahr?',
    ...
    website: 'https://www.nordbayern.de/panorama/unnutzes-wissen-1.13958782',
    description:
      'Ein erwachsener Mensch verliert im Erwachsenenalter rund ein Gramm Gehirnmasse pro Jahr.',
  },
  {
    ...
    website: 'https://www.nordbayern.de/panorama/unnutzes-wissen-1.13958782',
    description:
      'Die Dauer des Films „Titanic" entspricht etwa der Zeit, die das Schiff zum Sinken brauchte – rund 2 Stunden und 40 Minuten, also etwa 160 Minuten.',
  },
  {
    questionText:
      'Wie viele Trauben benötigt man ungefähr, um eine einzige Flasche Wein herzustellen?',
  ...
  },
  {
    ...
    website: 'https://www.nordbayern.de/panorama/unnutzes-wissen-1.13958782',
    description:
      'Leonardo da Vinci hat rund zehn Jahre gebraucht, um die Lippen der Mona Lisa zu malen.',
  },
  {
  ...
  {
    questionText:
      'Wie viele Minuten pro Tag sind deine Augen im Durchschnitt durch Blinzeln geschlossen?',
    ...
    website: 'https://www.nordbayern.de/panorama/unnutzes-wissen-1.13958782',
    description:
      'Durch das Blinzeln sind die Augen durchschnittlich rund 15 Minuten pro Tag geschlossen.',
  },
  {
  ...
  },
  {
    ...
    category: 'Geografie',
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
  ...
  {
    questionText:
      'Wie viel Tonnen wiegt ungefähr jeder einzelne Kalkstein- oder Granitblock der Großen Pyramide von Gizeh?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Jeder Kalkstein- oder Granitblock der Großen Pyramide von Gizeh wiegt etwa 2,5 Tonnen.',
  },
  {
    questionText:
      'Aus wie vielen einzelnen Steinblöcken besteht die Große Pyramide von Gizeh ungefähr?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Die Große Pyramide von Gizeh besteht aus rund 2,3 Millionen einzelnen Kalkstein- und Granitblöcken.',
  },
  {
    questionText:
      'Wie viele Monate würde es dauern, die gesamte Chinesische Mauer entlangzulaufen?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Es würde ungefähr 18 Monate dauern, die gesamte Chinesische Mauer entlangzulaufen.',
  },
  {
    questionText:
      'Wie viele Farben hat die Nationalflagge von Belize, die als Flagge mit den meisten Farben gilt?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Die Nationalflagge von Belize hat 12 verschiedene Farben und gilt damit als Flagge mit den meisten Farben.',
  },
  {
    questionText:
      'Wie viele Minuten dauerte der kürzeste Krieg der Geschichte, der Anglo-Sansibar-Krieg von 1896?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Der Anglo-Sansibar-Krieg von 1896 war mit einer Dauer von nur 38 Minuten der kürzeste Krieg der Geschichte.',
  },
  {
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Das älteste bekannte Kunstwerk der Welt auf der indonesischen Insel Sulawesi ist etwa 44.000 Jahre alt.',
  },
  {
  ...
  {
    questionText:
      'Welchen Wert in Millionen US-Dollar hat das Gemälde „Salvator Mundi" von Leonardo da Vinci ungefähr?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      '„Salvator Mundi" von Leonardo da Vinci gilt als das teuerste Gemälde der Welt und hat einen Wert von etwa 450,3 Millionen US-Dollar.',
  },
  {
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Frankreich war 2018 mit rund 90 Millionen Besuchern das meistbesuchte Land der Welt.',
  },
  {
  ...
  {
    questionText:
      'Wie viele Milliarden US-Dollar hat der Film „Avatar" weltweit ungefähr eingespielt?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      '„Avatar" ist einer der umsatzstärksten Filme aller Zeiten und hat über 2,9 Milliarden US-Dollar eingespielt.',
  },
  {
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Die Statue of Unity ist mit einer Höhe von etwa 182 Metern die höchste Statue der Welt.',
  },
  {
  ...
  {
    questionText:
      'Welcher Anteil der männlichen Weltbevölkerung stammt genetisch von Dschingis Khan ab?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Etwa 0,5 Prozent der männlichen Bevölkerung tragen ein Y-Chromosom, das auf Dschingis Khan zurückgeführt wird.',
  },
  {
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Russland ist das waldreichste Land der Welt mit rund 815 Millionen Hektar Waldfläche.',
  },
  {
  ...
  {
    questionText:
      'Wie weit sind die Tristan-da-Cunha-Inseln ungefähr vom nächstgelegenen bewohnten Ort St. Helena entfernt?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Die abgelegenen Tristan-da-Cunha-Inseln liegen etwa 2.434 Kilometer von St. Helena, dem nächstgelegenen bewohnten Ort, entfernt.',
  },
  {
    questionText:
      'Wie viele Computer setzt Google ungefähr ein, um eine Suchanfrage zu beantworten?',
    ...
    website:
      'https://www.ef.at/blog/language/50-unglaubliche-fakten-uber-die-welt-die-dich-kultiviert-wirken-lassen/',
    description:
      'Wenn du etwas googlest, werden etwa 1.000 Computer eingesetzt, um die Antwort zu finden.',
  },
  {
    questionText:
      'Wie viele Sekunden dauert es ungefähr, bis Google eine Antwort auf deine Suchanfrage liefert?',
  ...
  {
    questionText:
      'In welcher Entfernung in Meilen kann man das Gebrüll eines Tigers ungefähr hören?',
  ...
  },
  {
    ...
    hint2:
      'Das Alter liegt im Bereich von mehreren Milliarden Jahren – etwa zwischen 4 und 5 Milliarden.',
